if game.PlaceId == 17687504411 then
    ...
    local codes = {
        "DEADLOOP","MUDAMUDAMUDA", "SORRYFORDELAYS", "UPDATE5", "ALOTOFSHUT", "THANKYOUFOR540KLIKES", "SRRYFORSHUTDOWN", "THANKYOUFORPATIENCE", "MOREUPDATES", "MINORDELAY", "UPDATE4", "BIGFIX",
